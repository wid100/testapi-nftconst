...
function TopProject() {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/api/home/projects")
      .then((res) => res.json())
      .then(
        (result) => {
          setIsLoaded(true);
      ...
      <div className="projects cpy-6">
        <div className="section-title">
          ...
          <p className="sec-des">
            ...
            development, design, and consulting firm, our development and design
            services facilitate the tokenization of digital assets for
