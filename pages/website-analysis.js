      ...
      <div id="Analysis" className="cpt-5">
        <div className="decor-balls">
          <img
            height="auto"
            width="auto"
            src="assets/imgs/boll-1.png"
            alt="Ball"
          />
          <img
            height="auto"
            width="auto"
            src="assets/imgs/ball-2.png"
            alt="Ball"
          />
          <img
            height="auto"
            width="auto"
            src="assets/imgs/ball-3.png"
            alt="Ball"
          />
          {/* <img
                    height="auto"
                    width="auto" src="assets/imgs/ball-4.png" alt="Ball" /> */}
        </div>
          ...
          <section className="hero">
            ...
            >
              <img
                height="auto"
                width="auto"
                src="assets/imgs/hero-img-3.png"
                alt="Hero IMG"
              />
